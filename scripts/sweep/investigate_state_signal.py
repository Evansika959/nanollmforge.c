...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--output',default='scripts/sweep/outputs/state_signal_investigation_936')
    ...
    conditioned=ROOT/'scripts/sweep/outputs/xgboost_error_diagnosis_936'
